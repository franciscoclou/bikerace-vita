...
public class WorldItemView_Holiday extends RelativeLayout {
    ...
    public WorldItemView_Holiday(Context context, AttributeSet attributeSet, int i) {
        this(context, attributeSet);
    }

    public WorldItemView_Holiday(Context context, AttributeSet attributeSet) {
        ...
        this.n = null;
        a(attributeSet);
        ((LayoutInflater) context.getSystemService("layout_inflater")).inflate(2130903106, this);
        this.f1392a = findViewById(2131296754);
