...
public class WorldItemView_Thanksgiving extends RelativeLayout {
    ...
    public WorldItemView_Thanksgiving(Context context, AttributeSet attributeSet, int i) {
        this(context, attributeSet);
    }

    public WorldItemView_Thanksgiving(Context context, AttributeSet attributeSet) {
        ...
        this.n = null;
        a(attributeSet);
        ((LayoutInflater) context.getSystemService("layout_inflater")).inflate(2130903107, this);
        this.f1393a = findViewById(2131296754);
