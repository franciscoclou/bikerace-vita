...
public class GetItemRequestMarshaller {
    ...
    public j<GetItemRequest> marshall(GetItemRequest getItemRequest) {
        if (getItemRequest == null) {
            throw new a("Invalid argument passed to marshall(...)");
        }
        h hVar = new h(getItemRequest, "AmazonDynamoDB");
        hVar.a("X-Amz-Target", "DynamoDB_20111205.GetItem");
        ...
        try {
            ...
            if (getItemRequest.getTableName() != null) {
                fVar.a("TableName").a((Object) getItemRequest.getTableName());
            }
            ...
            if (getItemRequest.isConsistentRead() != null) {
                fVar.a("ConsistentRead").a(getItemRequest.isConsistentRead());
            }
            fVar.c();
