...
public class DescribeTableRequestMarshaller {
    ...
    public j<DescribeTableRequest> marshall(DescribeTableRequest describeTableRequest) {
        if (describeTableRequest == null) {
            throw new a("Invalid argument passed to marshall(...)");
        }
        h hVar = new h(describeTableRequest, "AmazonDynamoDB");
        hVar.a("X-Amz-Target", "DynamoDB_20111205.DescribeTable");
        ...
        try {
            ...
            if (describeTableRequest.getTableName() != null) {
                fVar.a("TableName").a((Object) describeTableRequest.getTableName());
            }
            fVar.c();
