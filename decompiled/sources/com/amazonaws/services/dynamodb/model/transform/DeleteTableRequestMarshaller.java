...
public class DeleteTableRequestMarshaller {
    ...
    public j<DeleteTableRequest> marshall(DeleteTableRequest deleteTableRequest) {
        if (deleteTableRequest == null) {
            throw new a("Invalid argument passed to marshall(...)");
        }
        h hVar = new h(deleteTableRequest, "AmazonDynamoDB");
        hVar.a("X-Amz-Target", "DynamoDB_20111205.DeleteTable");
        ...
        try {
            ...
            if (deleteTableRequest.getTableName() != null) {
                fVar.a("TableName").a((Object) deleteTableRequest.getTableName());
            }
            fVar.c();
