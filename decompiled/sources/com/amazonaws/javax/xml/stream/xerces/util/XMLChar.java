...
public class XMLChar {
    private static final byte[] CHARS = new byte[NativeProtocol.MESSAGE_GET_ACCESS_TOKEN_REQUEST];
    ...
    public static int supplemental(char c, char c2) {
        return ((c - 55296) * 1024) + (c2 - 56320) + NativeProtocol.MESSAGE_GET_ACCESS_TOKEN_REQUEST;
    }

    public static char highSurrogate(int i) {
        return (char) (((i - NativeProtocol.MESSAGE_GET_ACCESS_TOKEN_REQUEST) >> 10) + 55296);
    }

    public static char lowSurrogate(int i) {
        return (char) (((i - NativeProtocol.MESSAGE_GET_ACCESS_TOKEN_REQUEST) & 1023) + 56320);
    }
