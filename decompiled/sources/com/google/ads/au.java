...
public final class au {
    ...
    private void b() throws IOException {
        ...
        this.e.write(this.f630a, 0, this.c);
        this.c = 0;
    }
    ...
    public void a(byte[] bArr, int i, int i2) throws IOException {
        if (this.b - this.c >= i2) {
            System.arraycopy(bArr, i, this.f630a, this.c, i2);
            this.c += i2;
            this.d += i2;
            return;
        }
        int i3 = this.b - this.c;
        System.arraycopy(bArr, i, this.f630a, this.c, i3);
        int i4 = i + i3;
        int i5 = i2 - i3;
        this.c = this.b;
        this.d = i3 + this.d;
        b();
        if (i5 <= this.b) {
            System.arraycopy(bArr, i4, this.f630a, 0, i5);
            this.c = i5;
        } else {
    ...
    public void b(long j) throws IOException {
        while (((-128) & j) != 0) {
            a((((int) j) & 127) | XMLChar.MASK_NCNAME);
            j >>>= 7;
        }
        a((int) j);
    }
